...
2. To execute code chunks, use `Ctrl + Enter` (Windows) o `Cmd + Enter` (Mac)
3. To generate the final output, click on `Render` 
...
- Correlation between Anxiety pre and math quiz -> $r =$ `r cor_pre`
