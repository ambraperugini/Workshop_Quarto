...
\*Italic\* or \`single spaced font\` cam be used as well.
...
And it's done in the followinf way: `^[the note]` and you put it next to the text where you want the note number to appear
...
## Adding values in text directly form r objects
